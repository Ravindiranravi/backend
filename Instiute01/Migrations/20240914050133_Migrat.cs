        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateofPlaced = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CompanyPlaced = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ContactMail = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RecentylyPlacedStudents", x => x.StudentId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InterestToStudy = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BatchStudent", x => new { x.BatchesBatchId, x.StudentsStudentId });
                    table.ForeignKey(
                        name: "FK_BatchStudent_Batches_BatchesBatchId",
                        column: x => x.BatchesBatchId,
                        principalTable: "Batches",
                        principalColumn: "BatchId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BatchStudent_Students_StudentsStudentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BatchStudent_StudentsStudentId",
                table: "BatchStudent",
